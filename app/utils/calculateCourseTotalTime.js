// step 236 : time tamame episode haie darone chaptere course ro ba ham jam konim k neshon bdim

function calculateCourseTotalTime(chapters = []) {
  // hamishe arguman initial bede k b undefined nakhore
  let time,
    hour,
    minute,
    second = 0;
